...
function AplicarImpactos(evento)
{
    ...
    // var OperadorImpactado = new OperadorImpactado(
    //     {
    //         CEP: "123",
    //         ESCALA: "26",
    //         TURMA: "15",
    ...
    // impacto.OPERADORES_IMPACTADOS = [OperadorImpactado]; 

    // var EscalaImpactada = new EscalaImpactada(
    //     {
    ...
    // impacto.ESCALAS_IMPACTADAS = [EscalaImpactada];
